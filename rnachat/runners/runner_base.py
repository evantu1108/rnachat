...
from rnachat.common.dist_utils import (
...
from rnachat.common.utils import is_url
from rnachat.datasets.data_utils import concat_datasets, reorg_datasets_by_split, ChainDataset
from rnachat.datasets.datasets.dataloader_utils import (
    IterLoader,
    MultiIterLoader,
    PrefetchLoader,
)
...
class RunnerBase:
    ...
    def dataloaders(self) -> dict:
        ...
        if self._dataloaders is None:
            ...
            #         max_len_rna_dim0 = max(max_len_rna_dim0, shape_dim0)
            #         # print(f"max_len_rna_dim0: {max_len_rna_dim0}")
            #     for pdb_json in original_batch:
            #         pdb_coords = pdb_json["pdb_coords"]
            #         shape_dim0 = pdb_coords.shape[0]
            #         pad1 = ((0, max_len_rna_dim0 - shape_dim0), (0, 0), (0, 0))
